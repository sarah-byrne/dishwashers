...
class ProductGrid extends Component {
  constructor(props) {
    super(props);
    this.state = {
      products: this.productGenerate(5)
    };
  }
  productExample = {
    productId: "1391191",
    ...
    promotionalFeatures: [
      ...
      },
      {
        ...
        iconUrl: "//johnlewis.scene7.com/is/image/JohnLewis/energy_a_plus_ico?",
        linkUrl:
      ...
      },
      {
        ...
        linkUrl: "http://isitetv.com/en062124193003068134159184209234-p4jl.htm",
  ...
  productGenerate = amount => {
    var products = [];
    for (var i = 0; i < amount; i++) {
      products.push(this.productExample);
    }
    return products;
  };
